...
class ReviseLoan extends StatefulWidget {
  @override
  _ReviseLoanState createState() => _ReviseLoanState();
}

class _ReviseLoanState extends State<ReviseLoan> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            Text('Negotiate', style: GoogleFonts.muli(textStyle: TextStyle())),
      ),
